...
public class ASCIILevelLoader : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Camera.main.transform.position = (canvas.transform.position - new Vector3(230,255,20));
        if (startsing.instance.activeSelf == true)
        {
            startsing.instance.transform.localScale = new Vector3(.5f, .5f, .5f);
            startsing.instance.transform.position = canvas.transform.position - new Vector3(237.8f,264.58f,0f);
        }
    }
